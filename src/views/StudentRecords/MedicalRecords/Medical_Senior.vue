                  ...
                  <template v-slot:default>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-body">
                          <router-link to="/senior-records/medical/physical">
                      ...
                      <tr>
                        ...
                        <td class="table-body">
                          <router-link to="/senior-records/medical/dental">
                            <v-btn small color="primary">Details</v-btn>
                          </router-link>
                        </td>
                      </tr>
                  ...
                  <template v-slot:default>
                    <tbody>
                      ...
                      <tr v-for="(consultation, index) in consultations" :key="index">
                        ...
                        <td class="table-body">
                          <router-link to="/senior-records/medical/consultation/edit">
                          <v-btn small color="primary">Details</v-btn>
                          </router-link>
                        </td>
                      </tr>
