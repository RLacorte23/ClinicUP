        ...
        <div class="form-row">
          <div class="form-column">
            <div class="form-group">
              ...
              <input type="text" v-model="studentId" id="studentId"  required @input="validateStudentId" maxlength="9">
            </div>
            <v-spacer></v-spacer>
            <v-spacer></v-spacer>
            <div class="form-group">
              <label for="bloodPressure">Blood Pressure (BP)</label>
              <input type="text" v-model="bloodPressure" id="bloodPressure" required>
            </div>
            <div class="form-group">
              <label for="visionLeft">Vision (Left)</label>
              <input type="text" v-model="visionLeft" id="visionLeft" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="cl" id="cl"  required>
            </div>
            <div class="form-group">
              <label for="extremities">Extremities</label>
              <input type="text" v-model="extremities" id="extremities"  required>
            </div>
          </div>
          <div class="form-column">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="pulseRate" id="pulseRate"  required>
            </div>
            <div class="form-group">
              <label for="visionRight">Vision (Right)</label>
              <input type="text" v-model="visionRight" id="visionRight"  required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="abdomen" id="abdomen"  required>
            </div>
            <div class="form-group">
              <label for="skin">Skin</label>
              <input type="text" v-model="skin" id="skin"  required>
            </div>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group full-width">
            ...
            <input type="text" v-model="cvs" id="cvs"  required>
          </div>
          <div class="form-group full-width">
            <label for="personalFamilyHistory">Personal and Family Medical History</label>
            <textarea v-model="personalFamilyHistory" id="personalFamilyHistory" rows="3"  required></textarea>
          </div>
        </div>
        <div class="form-row">
          <div class="form-group full-width">
            <label for="remarks">Remarks</label>
            <textarea v-model="remarks" id="remarks" rows="3"  required></textarea>
          </div>
        </div>
        <hr>
        <div class="form-row">
