<template>
    <main>
      <div class="top-container">
        <h1 class="bg-title">Consultation Form</h1>
        <div class="studentProfile">
          <span class="material-icons">personal_injury</span>
          <span class="text">Consultation Form</span>
        </div>
      </div>
      <hr>
        ...
        <form @submit.prevent="submitForm">
          <div class="form-row">
            <div class="form-column">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="oxygenSaturation" id="oxygenSaturation" placeholder="*Insert Oxygen Saturation" required>
              </div>
            </div>
            <div class="form-column">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="diagnosis" id="diagnosis" placeholder="*Insert Diagnosis" required>
              </div>
              <div class="form-group">
                <label for="medicine">Medicine</label>
                <input type="text" v-model="medicine" id="medicine" placeholder="*Insert Medicine" required>
              </div>
              <div class="form-group">
                <label for="temperature">Temperature</label>
                <input type="text" v-model="temperature" id="temperature" placeholder="*Insert Temperature" required>
              </div>
            <v-spacer></v-spacer>
            </div>
          </div>
          <div class="form-row">
            <div class="form-group full-width">
              ...
              <input type="text" v-model="treatment" id="treatment" placeholder="*Insert Treatment" required>
            </div>
          </div>
          <hr>
          <div class="form-row">
    ...
    setup() {
      ...
      const submitForm = () => {
        alert(`
          ...
          Oxygen Saturation: ${oxygenSaturation.value}
